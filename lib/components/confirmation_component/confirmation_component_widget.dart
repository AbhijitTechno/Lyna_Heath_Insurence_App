...
class ConfirmationComponentWidget extends StatefulWidget {
  const ConfirmationComponentWidget({super.key});
                ...
                children: [
                  Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/Group_1707486029_(1).png',
                        width: 200.0,
                        height: 160.0,
                        fit: BoxFit.cover,
                      ),
                  ...
                  Text(
                    FFLocalizations.of(context).getText(
                      'vfynsslk' /* Your appointment has been succ... */,
                    ),
                    textAlign: TextAlign.center,
                  ...
                  FFButtonWidget(
                    ...
                    text: FFLocalizations.of(context).getText(
                      '7q2r4pnk' /* View Appointment Details */,
                    ),
