...
abstract class FlutterFlowTheme {
  ...
  late Color newTextColor;
  late Color sPrimaryColor;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryText = const Color(0xFF8496B0);
  ...
  late Color success = const Color(0xFF259F67);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);

  late Color newTextColor = Color(0xFF31353B);
  late Color sPrimaryColor = Color(0xFF003A80);
}
