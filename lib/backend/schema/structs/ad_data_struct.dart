...
class AdDataStruct extends BaseStruct {
  AdDataStruct({
    int? id,
    String? firstName,
    String? lastName,
  ...
  static AdDataStruct fromMap(Map<String, dynamic> data) => AdDataStruct(
  ...
  static AdDataStruct? maybeFromMap(dynamic data) =>
      data is Map ? AdDataStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static AdDataStruct fromSerializableMap(Map<String, dynamic> data) =>
      AdDataStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'AdDataStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is AdDataStruct &&
        id == other.id &&
...
AdDataStruct createAdDataStruct({
  int? id,
  String? firstName,
  String? lastName,
  String? image,
